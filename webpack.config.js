...
const config = {
	...
	plugins: [
		...
		new MiniCssExtractPlugin( {filename:'css/block-styling.css'} ),
...
module.exports = [
	...
	*/
	...
	Object.assign( {
		entry: {
			plugin: [ './assets/src/js/insertion-script.js' ],
		},
		output: {
			path: path.resolve( __dirname, './assets/dist/' ),
			filename: 'js/insertion-script.js',
		},
	}, config ),
...
if ( inProduction ) {
	...
	//exec( 'wp i18n make-pot . languages/servebolt-conversion-blocks.pot --exclude=assets/dist' );
